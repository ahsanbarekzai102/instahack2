...
' |lolcat
printf "\n"
printf "                \e[101m\e[1;77m  >>  Script By SSLRI << \e[0m\n"
printf "\n"
printf "       \e[100m\e[1;77m >>  instagram : \e[1;96m sslri \e[100m\e[1;77m << \e[0m\n"
printf "\n"
echo 
...
am start -a android.intent.action.VIEW -d https://sslri.ir
elif [[ $option == 6 || $option == 06 ]]; then
am start -a android.intent.action.VIEW -d https://wa.me/989384491252
elif [[ $option == 7 || $option == 07 ]]; then
am start -a android.intent.action.VIEW -d https://instagram.com/sslri
elif [[ $option == 8 ]]; then
exit 1
else
echo
