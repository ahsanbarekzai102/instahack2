...
# 1. SSLRI (github:https://github.com/sslri/, instagram : sslri)
#
...
function checkUpdates {
	...
	if wget --spider https://raw.githubusercontent.com/sslri/instahack/master/update.v1.3 2>/dev/null; then
