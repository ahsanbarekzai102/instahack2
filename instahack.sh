...
# 1. SSLRI (github:https://github.com/sslri/, email:sslri0276@gmail.com)
#
...
function checkUpdates {
	...
	if wget --spider https://raw.githubusercontent.com/sslri/instahack/master/update.v1.3 >/dev/null; then
	...
	if wget --spider https://raw.githubusercontent.com/sslri/sslripatch/main/instahack.v.1.3 >/dev/null; then
...
while true; do
	...
	echo -e "\e[1;92m[\e[0m\e[1;77m5\e[0m\e[1;92m]\e[0m\e[1;93m instagram\e[0m"
	echo -e "\e[1;92m[\e[0m\e[1;77m6\e[0m\e[1;92m]\e[0m\e[1;93m telegram\e[0m"
	echo -e "\e[1;92m[\e[0m\e[1;77m7\e[0m\e[1;92m]\e[0m\e[1;93m youtube\e[0m"
	...
	if [[ $option == 1 || $option == 01 ]]; then
		...
		am start -a android.intent.action.VIEW -d https://telegram.me/sslri > /dev/null 2>&1
